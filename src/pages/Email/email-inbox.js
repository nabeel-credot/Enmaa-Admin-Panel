...
const EmailInbox = () => {
  //meta title
  document.title = "Email Inbox | enmaa.com";
                ...
                <Card>
                  ...
                  <ul className="message-list">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          ...
                          Off on Thursday - <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          ...
                          This Week's Top Stories – <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          Montly High-Res Photos – <span className="teaser">
                    ...
                    <li className="unread">
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          ...
                          Last pic over my village – <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          Sveriges Hetaste sommarjobb – <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          ...
                          Weekend on Revibe – <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          Regarding our meeting – <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          Let's go fishing! – <span className="teaser">
