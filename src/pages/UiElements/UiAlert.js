...
import { Alert, Card, CardBody, CardHeader, Col, Container, Row, UncontrolledAlert } from "reactstrap"
...
const UiAlert = () => {
    ...
    //meta title
    document.title = "Alert | enmaa.com";
    return (
        <React.Fragment>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <UncontrolledAlert color="danger" className="alert-border-left">
                        ...
                        <Col xl={6}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="card-title-desc">Add <code>.alert-top-border</code> class with for top alerts.</p>
                                </CardHeader>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <div id="liveAlertPlaceholder">
                                            <Alert color="primary" isOpen={show} toggle={() => setShow(false)}>
                        ...
                        <Col xl={12}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="card-title-desc">Alert label add <code>.alert-heading</code> class with additional content example</p>
                                </CardHeader>
                                <CardBody>
