...
const UiOffCanvas = () => {
    ...
    //meta title
    document.title = "OffCancas | enmaa.com";
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="card-title-desc">
                                        Use the buttons below to show and hide an offcanvas element via JavaScript that toggles the <code>.show</code> class on an element with the <code>.offcanvas</code> class.</p>
                                ...
                                <CardBody className='d-flex flex-wrap gap-2'>
                                        ...
                                        <Offcanvas isOpen={open} toggle={toggleLeftCanvas}>
                                            ...
                                            <OffcanvasBody>
                                                ...
                                                <UncontrolledDropdown className="mt-3">
                                                    <DropdownToggle className="btn btn-primary" tag="button" id="dropdownMenuButton" >
                                    ...
                                    <div>
                                        <Button color="primary" onClick={toggleLeftCanvas}>
