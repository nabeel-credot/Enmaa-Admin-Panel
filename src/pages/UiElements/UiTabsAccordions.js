...
const UiTabsAccordions = () => {
  ...
  //meta title
  document.title = "Tabs & Accordions | enmaa.com";
        ...
        <Container fluid>
          ...
          <Row>
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  <CardTitle className="h4">Always Accordion</CardTitle>
                  <p className="card-title-desc">
                    Omit the parent attribute on each <code>.accordion-collapse</code> to make accordion items stay open when another item is opened.
                  </p>
                </CardHeader>
                <CardBody>
                  <div
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  <CardTitle className="h4">Collapse Example</CardTitle>
                  <p className="card-title-desc">
            ...
            <Col xl="6">
              <Card>
                <CardHeader>
                  ...
                  <p className="card-title-desc">
                    The collapse plugin also supports horizontal collapsing. Add the <code>.collapse-horizontal</code> modifier
                    class to transition the <code>width</code> instead of <code>height</code> and set a <code>width</code> on the
                ...
                <CardBody>
                  <p>
                    <button className="btn btn-primary" onClick={() => setcollOpen(!collOpen)}>
                      Toggle Width Collapse
                    </button>
                  </p>
                  <div style={{ minHeight: "120px" }}>
                    <Collapse isOpen={collOpen} dimension="width" className="collapse-horizontal">
                      <Card>
                        <CardBody className="mb-0" style={{ maxWidth: "300px" }}>
