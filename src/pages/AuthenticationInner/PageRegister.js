...
const PageRegister = () => {
    ...
    //meta title
    document.title = "Register | enmaa.com";
    return (
        <React.Fragment>
                                    ...
                                    <div className="d-flex flex-column h-100">
                                        <div className="mb-4 mb-md-5 text-center">
                                            <Link to="/dashboard" className="d-block auth-logo">
                                                <img src={logo} alt="" height="28" /> <span className="logo-txt">Enma'a</span>
                                            </Link>
                                        </div>
                                            ...
                                            <form className="needs-validation custom-form mt-4 pt-2" action="/dashboard">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" className="form-control" id="username"
                                                        defaultValue="admin@Anathoth.com"
                                        ...
                                        <div className="mt-4 mt-md-5 text-center">
                                            <p className="mb-0">© {year} Minia   . Crafted with <i className="mdi mdi-heart text-danger"></i> by Anathoth</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
