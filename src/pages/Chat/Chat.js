...
const Chat = props => {
  ...
  const [Chat_Box_Image, setChat_Box_Image] = useState(images.avatar1)
  // eslint-disable-next-line no-unused-vars
          ...
          <div className="d-lg-flex">
            <Card className="chat-leftsidebar">
              ...
              <div className="chat-leftsidebar-nav">
                <Nav pills justified className="bg-soft-light p-1 nav nav-pills nav-justified bg-light-subtle p-1 nav nav-pills nav-justified">
                  <NavItem>
                    <NavLink
                      href="#"
                ...
                <TabContent activeTab={activeTab}>
                  ...
                  <TabPane tabId="2">
                    <PerfectScrollbar className="chat-message-list" style={{ height: "530px" }}>
                      <div className="pt-3">
                        <div className="px-3">
                              ...
                              <Form className="p-3">
                                <FormGroup className="m-0">
                                  <InputGroup>
                                    <Input
                                      type="text"
                                      className="form-control border bg-light-subtle form-control"
                                      placeholder="Search ..."
